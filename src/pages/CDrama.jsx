...
const CDrama = () => {
    ...
    const sliderMovies = cDramas.slice(0, 12);

    // Calculate movies for the current page
    const indexOfLastMovie = currentPage * moviesPerPage;
    const indexOfFirstMovie = indexOfLastMovie - moviesPerPage;
    const currentMovies = cDramas.slice(indexOfFirstMovie, indexOfLastMovie);

    // Total number of pages
    const totalPages = Math.ceil(cDramas.length / moviesPerPage);
